...
- Адаптивные размеры уточнены автотестами на 4 разрешениях
"""
...
VIEWPORT_NAMES = ["Desktop", "Tablet", "Mobile390", "Mobile320"]

# ─── Размеры шрифтов: базовые (Desktop) ─────────────────────────────────────
...
# ─── Размеры шрифтов по разрешениям ─────────────────────────────────────────
# Проверено автотестами: на мобильных H2 и кнопка уменьшаются до 18px.

FONT_SIZES_BY_VIEWPORT = {
    "Desktop": {
        "h2": "22px",
        "button": "22px",
        "body": "14px",
